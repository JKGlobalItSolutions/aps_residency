...
// Internal context to share carousel state/actions
...
const Carousel = React.forwardRef(function Carousel(
  ...
  const onSelect = React.useCallback((apiInst) => {
    if (!apiInst) return;
    setCanScrollPrev(apiInst.canScrollPrev());
    setCanScrollNext(apiInst.canScrollNext());
  }, []);
